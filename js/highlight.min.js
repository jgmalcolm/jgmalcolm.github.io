...
hljs.registerLanguage("z80asm",function(a){return{cI:true,l:"\\.?"+a.IR,k:{keyword:"adc add and bit call ccf cp cpd cpdr cpi cpir cpl daa dec di djnz ei ex en halt im in inc ind indr ini inir jp jr ld ldd lddr ldi ldir neg nop or otdr otir outd outi out pop push res ret rl rla rlc rlca rld rr rra rrc rrca rst sbc scf set sla sra srl sub xor",built_in:"a b c d e h l bc de hl ix iy r af sp",preprocessor:"#include #define #defcont .db .dw .word $ .end = .org .pad .text /"},c:[a.CBCM,{cN:"comment",b:";",e:"$",r:0},a.CNM,a.BNM,{cN:"number",b:"(\\$[a-zA-Z0-9]+|0o[0-7]+|%[01]+)"},a.QSM,{cN:"string",b:"[^f]'",e:"[^\\\\]'",i:"[^\\\\][^']"},{cN:"label",b:"^[A-Za-z0-9_.$]+[ \t]*(:|=|\.?equ)"},{cN:"preprocessor",b:"#",e:"$"},{cN:"localvars",b:"@[0-9]+"}]}});
