...
$('main').html(html.replace(/(J\.?|J\.? ?G\.?) Malcolm/g, '<b>$&</b>')
                   ...
                   .replace(/, Malcolm/g, ', <b>Malcolm</b>')
                   .replace(/DOI:(10.(\d)+)\/([^\s<,]+)/gi, "doi:<a href='http://dx.doi.org/$1/$3'>$1/$3</a>")
                   .replace(/PMC([\d]+)/gi, "pubmed:<a href='http://www.ncbi.nlm.nih.gov/pmc/articles/PMC$1'>$1</a>")
                   .replace(/PMID:([\d]+)/gi, "pubmed:<a href='http://www.ncbi.nlm.nih.gov/pubmed/$1'>$1</a>"));
//-->
</script>
